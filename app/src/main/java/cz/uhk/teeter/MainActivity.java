...
//
//        float velX = (sphere.velocity[0] * nowFriction) + (xValue);
//        float velY = (sphere.velocity[1] * nowFriction) + (yValue);
//
//        sphere.velocity[0] = (alpha * sphere.velocity[0]) + (1 - alpha) * velX;
//        sphere.velocity[1] = (alpha * sphere.velocity[1]) + (1 - alpha) * velY;
//
